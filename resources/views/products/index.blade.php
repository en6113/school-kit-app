            ...
            <div class="border rounded-lg overflow-hidden shadow-sm hover:shadow-md transition">
                ...
                <div class="h-48 bg-gray-200 flex items-center justify-center">
                    ...
                    @if($product->item_type === 'product' && isset($product->productImages) && $product->productImages->isNotEmpty())
                        <img src="{{ asset('storage/' . $product->productImages->first()->image_url) }}" class="w-full h-full object-cover">
                    @else
                ...
                <div class="p-4">
                    ...
                    <div class="flex justify-between items-center">
                        {{-- 詳細リンク --}}
                        <a href="{{ route('products.show', $product->id) }}" class="text-blue-500 hover:underline text-sm">詳細を見る</a>
                    </div>
                </div>
            </div>
        @endforeach
